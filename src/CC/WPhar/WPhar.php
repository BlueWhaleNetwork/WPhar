...
class WPhar extends PluginBase
{
    /** @var WPhar obj */
    public static $obj;
    /** @var string path */
    ...
    private function registerCommands(){
        foreach($this->getCommands()->getAll() as $name=>$cmd){
            $class = "CC\\WPhar\\Commands\\".$name;
            $this->getServer()->getCommandMap()->register("WPhar",new $class($this));
        }
    }
    ...
    public function unpackPhar(string $name, string $target){
        ...
        $fileName = $this->getDataFolder().$name;
    ...
    public function packDir(string $dir, string $name){
        ...
        $fileName = $this->getDataFolder().$name.".phar";
        if(file_exists($fileName)){
